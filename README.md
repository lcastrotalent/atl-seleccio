...
3. Clica **Desar** — la clau es guarda al teu navegador i no caldrà tornar-la a introduir
...
5. Clica **Generar pack de difusió i descarregar PDF**
6. Espera uns 30-60 segons mentre es generen els 6 apartats
7. Quan acabi, s'obrirà una previsualització. Clica **Imprimir / Desar PDF** i selecciona **Desar com a PDF**
...
| **D. Portals de feina** | Anunci complet per a InfoJobs, Indeed, Feina.cat |
| **E. Pack FP** | Email al centre, text per a borsa, missatge per a tutor/a i per a alumnat |
| **F. Pla de canals** | Taula operativa amb tots els canals, moments d'activació i indicadors |
...
- El cost per pack generat és aproximadament **0,05-0,08 €**
...
**No es carrega el fitxer** → Assegureu-vos que és `.docx`, `.pdf` o `.txt`. Si no funciona, copieu el text i enganxeu-lo al camp de text manual.

**Error de clau d'API** → Comproveu que la clau comença per `sk-ant-` i que l'heu desat correctament.
